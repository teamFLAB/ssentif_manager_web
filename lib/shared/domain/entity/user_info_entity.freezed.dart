...
class _$UserInfoEntityImpl implements _UserInfoEntity {
  ...
  @override
  String toString() {
    return 'UserInfoEntity(userId: $userId, imageUrl: $imageUrl, userName: $userName, phoneNumber: $phoneNumber, gender: $gender, age: $age, matchingStatus: $matchingStatus, exercisePurposes: $exercisePurposes, status: $status)';
  }
...
abstract class _UserInfoEntity implements UserInfoEntity {
  const factory _UserInfoEntity(
      ...
      final String status}) = _$UserInfoEntityImpl;
