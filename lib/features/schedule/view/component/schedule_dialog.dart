            ...
            GestureDetector(
              ...
              child: Row(
                children: [
                  Text(
                      userName,
                      style: ScDreamStyles.bold18(AppColors.white)
                  ),
      ...
      child: Column(
        children: [
          ClickableText(
              ...
              textAlign: TextAlign.center,
              textStyle: ScDreamStyles.medium16(AppColors.white),
              boxShadow: boxShadow,
          ...
          ClickableText(
              ...
              textAlign: TextAlign.center,
              textStyle: ScDreamStyles.medium16(AppColors.modalTextGreen),
              boxShadow: boxShadow,
              borderRadius: BorderRadius.circular(11),
              onClick: () {
                Navigator.pop(context);
          ...
          ClickableText(
              ...
              textAlign: TextAlign.center,
              textStyle: ScDreamStyles.medium16(AppColors.subColorRed),
              boxShadow: boxShadow,
              borderRadius: BorderRadius.circular(11),
              onClick: () {
                Navigator.pop(context);
      ...
      children: [
        Expanded(
          child: ClickableText(
              ...
              backgroundColor: AppColors.white,
              textAlign: TextAlign.center,
              textStyle: ScDreamStyles.medium16(AppColors.gray2),
              boxShadow: boxShadow,
              borderRadius: BorderRadius.circular(11),
              onClick: () {
                Navigator.pop(context);
