...
/// @nodoc
mixin _$ScheduleDetailHasRoutineEntity {
  int get scheduleId => throw _privateConstructorUsedError;
  String get startDate => throw _privateConstructorUsedError;
  String get endDate => throw _privateConstructorUsedError;
  String get startTime => throw _privateConstructorUsedError;
  ...
  UserInfoEntity get userInfo => throw _privateConstructorUsedError;
  List<UserInfoEntity> get groupClients => throw _privateConstructorUsedError;
  bool get hasRoutine => throw _privateConstructorUsedError;

  /// Create a copy of ScheduleDetailHasRoutineEntity
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ScheduleDetailHasRoutineEntityCopyWith<ScheduleDetailHasRoutineEntity>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ScheduleDetailHasRoutineEntityCopyWith<$Res> {
  factory $ScheduleDetailHasRoutineEntityCopyWith(
          ScheduleDetailHasRoutineEntity value,
          $Res Function(ScheduleDetailHasRoutineEntity) then) =
      _$ScheduleDetailHasRoutineEntityCopyWithImpl<$Res,
          ScheduleDetailHasRoutineEntity>;
  @useResult
  $Res call(
      {int scheduleId,
      String startDate,
...
/// @nodoc
class _$ScheduleDetailHasRoutineEntityCopyWithImpl<$Res,
        $Val extends ScheduleDetailHasRoutineEntity>
    implements $ScheduleDetailHasRoutineEntityCopyWith<$Res> {
  _$ScheduleDetailHasRoutineEntityCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      groupClients: null == groupClients
          ...
          : groupClients // ignore: cast_nullable_to_non_nullable
              as List<UserInfoEntity>,
      hasRoutine: null == hasRoutine
          ? _value.hasRoutine
          : hasRoutine // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
...
/// @nodoc
abstract class _$$ScheduleDetailHasRoutineEntityImplCopyWith<$Res>
    implements $ScheduleDetailHasRoutineEntityCopyWith<$Res> {
  factory _$$ScheduleDetailHasRoutineEntityImplCopyWith(
          _$ScheduleDetailHasRoutineEntityImpl value,
          $Res Function(_$ScheduleDetailHasRoutineEntityImpl) then) =
      __$$ScheduleDetailHasRoutineEntityImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int scheduleId,
...
/// @nodoc
class __$$ScheduleDetailHasRoutineEntityImplCopyWithImpl<$Res>
    extends _$ScheduleDetailHasRoutineEntityCopyWithImpl<$Res,
        _$ScheduleDetailHasRoutineEntityImpl>
    implements _$$ScheduleDetailHasRoutineEntityImplCopyWith<$Res> {
  __$$ScheduleDetailHasRoutineEntityImplCopyWithImpl(
      _$ScheduleDetailHasRoutineEntityImpl _value,
      $Res Function(_$ScheduleDetailHasRoutineEntityImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ScheduleDetailHasRoutineEntityImpl(
      scheduleId: null == scheduleId
          ? _value.scheduleId
          : scheduleId // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$ScheduleDetailHasRoutineEntityImpl
    implements _ScheduleDetailHasRoutineEntity {
  const _$ScheduleDetailHasRoutineEntityImpl(
      {this.scheduleId = -1,
      this.startDate = "",
      this.endDate = "",
      this.startTime = "",
  ...
  @override
  String toString() {
    return 'ScheduleDetailHasRoutineEntity(scheduleId: $scheduleId, startDate: $startDate, endDate: $endDate, startTime: $startTime, endTime: $endTime, runningTime: $runningTime, scheduleTitle: $scheduleTitle, scheduleMemo: $scheduleMemo, scheduleStatusType: $scheduleStatusType, scheduleType: $scheduleType, totalNumberOfTime: $totalNumberOfTime, leftNumberOfTime: $leftNumberOfTime, schedulePrecautions: $schedulePrecautions, classInfoId: $classInfoId, repeatName: $repeatName, voucherMatchingId: $voucherMatchingId, voucherInfoEntity: $voucherInfoEntity, userInfo: $userInfo, groupClients: $groupClients, hasRoutine: $hasRoutine)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ScheduleDetailHasRoutineEntityImpl &&
            (identical(other.scheduleId, scheduleId) ||
                other.scheduleId == scheduleId) &&
            (identical(other.startDate, startDate) ||
                other.startDate == startDate) &&
            ...
            const DeepCollectionEquality()
                .equals(other._groupClients, _groupClients) &&
            (identical(other.hasRoutine, hasRoutine) ||
                other.hasRoutine == hasRoutine));
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ScheduleDetailHasRoutineEntityImplCopyWith<
          _$ScheduleDetailHasRoutineEntityImpl>
      get copyWith => __$$ScheduleDetailHasRoutineEntityImplCopyWithImpl<
          _$ScheduleDetailHasRoutineEntityImpl>(this, _$identity);
}

abstract class _ScheduleDetailHasRoutineEntity
    implements ScheduleDetailHasRoutineEntity {
  const factory _ScheduleDetailHasRoutineEntity(
      {final int scheduleId,
      final String startDate,
      final String endDate,
      final String startTime,
      ...
      final bool hasRoutine}) = _$ScheduleDetailHasRoutineEntityImpl;
