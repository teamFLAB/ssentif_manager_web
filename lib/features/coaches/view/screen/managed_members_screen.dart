...
class ManagedMembersScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final viewModel = ref.watch(managedMembersViewModelProvider(selectedCoach).notifier);
                ...
                children: [
                  ...
                  Expanded(
                    child: ClientDetailWidget(
                        ...
                        onClickThisMonth: () {
                          viewModel.handleIntent(
                              ManagedMembersIntent.clickThisMonth());
                        },
                        ...
                        onClickNextMonth: () {
                          viewModel.handleIntent(
                              ManagedMembersIntent.clickNextMonth());
                        }),
                  ),
                ],
              ),
